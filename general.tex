...
%
%\begin{tabular}{rl}
%General Knowledge: & Combinatorics, Graph Theory, Statistics, Algorithms.skip\\
%Specialized Knowledge: & Differential Equations (Ordinary and Partial), Linear Algebra, Numerical Computation.\\
%\end{tabular}
%
%%----------------------------------------------------------------------------------------
%%	COMPUTING SKILLS 
...
%
%\begin{tabular}{rl}
%General Knowledge: & Python, C++, VBA, Access, Linux, {\fb \LaTeX}, Beamer.skip\\
%Specialized Knowledge: & MATLAB, FORTRAN, Java, Excel, Word, PowerPoint.\\
%\end{tabular}
